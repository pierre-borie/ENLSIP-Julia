...
0.50882
\end{pmatrix}$$
Ce résultat, \mfabian{illustré à la figure~\ref{fig:courbe3}}\fabian{Utilise les références,e et ne force pas le placement d'une figure avec !h.}, est bien plus proche du résultat que l'on souhaite obtenir. Il montre également, bien que le modèle soit simple, la sensibilité au point de départ dont le choix est un élément important.
\begin{figure}[htbp]
\centering
