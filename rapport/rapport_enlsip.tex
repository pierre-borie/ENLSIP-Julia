...
Par transposition et par le fait que $P_{a}P_{a}^{T} = I_{t}$\fabian{Plus simplementation, une matrice de permutation est elle-même orthogonale, et la transposée d'une matrice orthogonale est égale à son inverse.}, on obtient:
\begin{equation}
\ha_{k} = P_{a}
\begin{pmatrix}
L_{a} & 0
